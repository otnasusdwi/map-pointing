...
<div class="container" style="margin-top: 30px;">
   ...
   <div class="card">
      <div class="card-body">
         ...
         @endif
         <a href="{{ route('admin.lokasi.create') }}" class="btn btn-lg btn-primary"
               ...
               <table class="table table-hover">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>{{ $lokasi->nama }}</td>
                        <td>
                           <a href="{{ route('admin.lokasi.edit', $lokasi->id) }}" class="btn btn-sm btn-primary">
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                           ...
                           <a href="#" class="btn btn-sm btn-danger"
                              onclick="del('{{ url('admin/lokasi/destroy', $lokasi->id) }}')">
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
